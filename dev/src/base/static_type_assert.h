...
__STATIC_TYPE_ASSERT_VAR_TYPE_ASSERT(std::is_integral, AssertIsIntegral,
                                     "Integral type(s) expected.");
// Usage:
// IsFloating<TemplateParameters...>()
__STATIC_TYPE_ASSERT_VAR_TYPE_ASSERT(std::is_floating_point, AssertIsFloating,
                                     "Floating point type(s) expected.");
...
template <class T, class... Args>
void AssertIsConvertibleTo() {
  static_assert(internal::IsConvertibleTo_and<T, Args...>::value,
                "Cannot "
